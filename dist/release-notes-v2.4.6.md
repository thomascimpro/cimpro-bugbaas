...
![BugBaas 2.4 update](https://github.com/thomascimpro/cimpro-bugbaas/releases/download/v2.4.6/bugbaas-2.4.0-release-card.png)
...
## 2.4.6 hotfix
- Ruilen accepteren gebruikt weer de oude werkende inventory-swap route.
- De accept-flow leest geen private BugDex unlock-history meer van de andere speler, waardoor de permission-error verdwijnt.
