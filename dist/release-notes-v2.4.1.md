...
## 2.4.1 hotfix
- Movement rewards tellen geen losse fake afstand meer zonder bijpassende stappen.
- Random Duel gebruikt nu ook de server-side `startAt`, zodat een open random duel direct speelbaar start.
